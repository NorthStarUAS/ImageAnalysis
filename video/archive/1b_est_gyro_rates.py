...
# scan a flight movie and estimate roll/pitch/yaw rates using feature
# detection, feature matching, and fitting the 'essential' matrix.
# (This comes from the visual odometry world.)
#
# This could be thought of as a 'visual gyro'.

...
def render(project_dir, render_options):
    ...
    Panda3d.generate_from_grid(proj, groups[group_id], src_dir=img_src_dir,
    ...
    #               version=1.0, trans=0.1, resolution=texture_resolution)
...
if __name__ == "__main__":
    ...
    render(args.project, render_options)